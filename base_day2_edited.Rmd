...
`r params$my_name`, Principal Investigator, `r params$institution`
...
All original data, code, or reports produced as part of this project are owned by Your `r params$institution` per its institutional intellectual property policy.
...
res <- orcid_bio(orcid = "0000-0001-7901-3936")
bio <- res$'0000-0001-7901-3936'$'content'
